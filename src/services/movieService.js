...
export async function create(movieName, posterLink, description, movieCategory, genres, director, premiere, length, cast, type, movieRating) {
    let res = await fetch(`${url}/create`, {
        ...
        body: JSON.stringify({ movieName, posterLink, description, movieCategory, genres, director, premiere, length, cast, type, movieRating }),
    });
